...
const Dashboard = () => {
    return (
        <div className="grid grd-cols-1 md:grid-cols-2 xl:grid-cols-3 xl:overflow-auto gap-10 pb-4 custom-grid-rows">
            <CardPopularProducts />
            <CardSalesSummary />
            <CardPurchaseSummary />
            <CardExpenseSummary />
            ...
            <StatCard 
                ...
                dateRange="22 - 29 October 2023"
                details={[
                    {title: "Dues", amount: "255.00", changePercentage: 131, IconComponent: TrendingUp},
